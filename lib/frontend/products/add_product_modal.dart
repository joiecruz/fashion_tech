...
import 'components/product_basic_info.dart';
import 'components/supplier_dropdown.dart';
import 'components/product_variants_section.dart';
import 'components/product_properties.dart';
import 'components/product_additional_info.dart';
...
class _AddProductModalState extends State<AddProductModal>
    ...
    try {
      ...
      if (_selectedSupplierID != null && _selectedSupplierID!.isNotEmpty) {
        final selectedSupplier = _suppliers.firstWhere(
          ...
          orElse: () => {'supplierName': 'Unknown Supplier'},
        );
        consolidatedDescription += 'Supplier/Source: ${selectedSupplier['supplierName']}';
      }
  ...
  void _addVariant(ProductVariantInput variant) {
    setState(() {
  ...
  void _updateVariant(int index, String size, String color, int quantity) {
    setState(() {
      _variants[index].size = size;
      _variants[index].color = color;
      _variants[index].quantityInStock = quantity;
    });
  }
